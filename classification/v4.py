...
# class ChannelAttention(nn.Module):
#     """Channel attention with adaptive average pooling and adaptive max pooling.
#
#     Args:
#         num_feat (int): Channel number of intermediate features.
#         squeeze_factor (int): Channel squeeze factor. Default: 16.
...
#     """
#
#     def __init__(self, in_channels, square_kernel_size=3, band_kernel_size=5, branch_ratio=0.125):
#         super().__init__()
#
